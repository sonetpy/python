...
# Static Method : In this we don't have to take either Class or instance as first parameter.
# We can just create a method without a class or instance as it's parameter.
