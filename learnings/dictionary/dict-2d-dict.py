...
print ("Marks of Jose in all Subjects :")
marks = {'peter': [80,85,90], 'jose' : [85,90,95]}
print (marks['jose'])

print ("Marks of 1st Subject:")
print (marks['jose'][0])

print ("Updating the Marks of Jose for 2nd Subject")
marks['jose'][0] = 86
print ("\nUpdated marks now for Jose's 1st Subject: ", marks['jose'])
