...
weather_data = response.json()['hourly'][0]['weather'][0]['id'] # Got data only for hourly so that I can run FOR loop
...
for i in range(0, 23):
    ...
    if id < 700:
        print ("High chance of Rain at {}Hrs at Latitude {} and Longitude {}, better take an umbrella".format(i, MY_LAT, MY_LON))
        break

else:
    print("Sky is clear it will not rain in next 24Hrs")